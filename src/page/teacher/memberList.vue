    ...
    >
      <el-form :model="ruleFormfakaClass" ref="ruleFormfakaClass" :rules="rulesfakaClass" label-width="100px"
        ...
        <el-form-item label="有效天数：" v-if="ruleFormfakaClass.CardID>0 &&showyxdays" prop="CardDays">
          <el-input v-model="ruleFormfakaClass.CardDays" v-on:input="inputSubtotal1(ruleFormfakaClass)"
                    placeholder="有效天数" style="width:100px;"></el-input>
          天
        </el-form-item>
        <el-form-item label="到期时间："
                      v-if="ruleFormfakaClass.CardID>0 &&ruleFormfakaClass.iskaika=='1' && (ruleFormfakaClass.CardType==1 || ruleFormfakaClass.CardType==3)"
                      prop="EndTime">
        ...
        <el-form-item label="应收金额：" v-if="ruleFormfakaClass.CardID>0 &&showPurchaseAmount" prop="YSAmount">
          <el-input v-if="isgoumaijine==1" v-model="ruleFormfakaClass.YSAmount" placeholder="应收金额"
        ...
        <el-form-item label="实收金额：" v-if="ruleFormfakaClass.CardID>0 &&showPurchaseAmount" prop="PurchaseAmount">
          <el-input v-if="isgoumaijine==1" v-model="ruleFormfakaClass.PurchaseAmount" placeholder="实收金额"
                    style="width:100px;"></el-input>
          <span v-if="isgoumaijine==1">元</span>
