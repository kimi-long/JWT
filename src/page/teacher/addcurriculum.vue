    ...
    <el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="120px" label-position="top">
      ...
      <el-form-item label="预约方式：" prop="preAboutType">
        <el-radio-group v-model="RowClassType">
          <el-radio label="0"><span style="display: inline-block;margin-left: 20px">班课(一对多)</span></el-radio>
          <el-radio label="1"><span style="display: inline-block;margin-left: 20px">私教(一对一)</span></el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="消耗次卡次数：" v-if="showConsumptionOfClass" prop="ConsumptionOfClass">
  ...
  export default {
    ...
    methods: {
      ...
      changeTimePeriod(val) {
        if (val == "1") {
          this.MorningTime = "6:00";
          this.ruleForm.startTime = "6:00"
        } else if (val == "2") {
